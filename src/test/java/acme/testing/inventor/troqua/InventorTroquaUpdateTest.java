...
public class InventorTroquaUpdateTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/troqua/update-positive-troqua.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/troqua/update-negative-troqua.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(20)
